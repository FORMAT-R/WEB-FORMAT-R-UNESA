...
class DepartemenController extends Controller
{
        ...
        return [
            [
                ...
                'ornaments' => [
                    ...
                    ['pos' => 'top: 70%; right: 10%; transform:rotate(15deg);', 'svg' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"/></svg>'], // edit
                    ['pos' => 'top: 85%; left: 15%; transform:rotate(-10deg);', 'svg' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>'], // star
            ...
            [
                ...
                'ornaments' => [
                    ...
                    ['pos' => 'top: 75%; right: 10%; transform:rotate(15deg);', 'svg' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>'], // monitor
                    ['pos' => 'top: 85%; left: 15%; transform:rotate(-10deg);', 'svg' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"/><line x1="12" y1="18" x2="12.01" y2="18"/></svg>'], // smartphone
            ...
            [
                ...
                'ornaments' => [
                    ...
                    ['pos' => 'top: 70%; left: 12%; transform:rotate(15deg);', 'svg' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>'], // book
                    ['pos' => 'top: 85%; right: 8%; transform:rotate(-12deg);', 'svg' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>'], // download
            ...
            [
                ...
                'ornaments' => [
                    ...
                    ['pos' => 'top: 75%; right: 10%; transform:rotate(-8deg);', 'svg' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="2" y="4" width="20" height="16" rx="2" ry="2"/><line x1="2" y1="10" x2="22" y2="10"/></svg>'], // credit card
                    ['pos' => 'top: 85%; left: 12%; transform:rotate(10deg);', 'svg' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M22 11.08V12a10.02 10.02 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>'], // check circle
            ...
            [
                ...
                'ornaments' => [
                    ...
                    ['pos' => 'top: 75%; right: 5%; transform:rotate(8deg);', 'svg' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 2l3 6 6 1-4 4 1 6-6-3-6 3 1-6-4-4 6-1z"/></svg>'], // star
                    ['pos' => 'top: 55%; left: 10%; transform:rotate(-12deg);', 'svg' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="12" r="10"/><path d="M12 8v4l3 3"/></svg>'], // clock
            ...
            [
                ...
                'ornaments' => [
                    ...
                    ['pos' => 'top: 75%; right: 12%; transform:rotate(-5deg);', 'svg' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M2 12h20M12 2v20M7 7l10 10M17 7L7 17"/></svg>'], // spark
                    ['pos' => 'top: 90%; left: 15%; transform:rotate(15deg);', 'svg' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>'], // box
            ...
            [
                ...
                'ornaments' => [
                    ...
                    ['pos' => 'top: 75%; left: 10%; transform:rotate(12deg);', 'svg' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>'], // pen
                    ['pos' => 'top: 90%; right: 15%; transform:rotate(-10deg);', 'svg' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="9" y1="3" x2="9" y2="21"/></svg>'], // layout
    ...
    public function show($slug)
    {
        ...
        if ($db->programs->isNotEmpty()) {
            $dept['proker'] = $db->programs->map(function($p) {
                return [
                    'no' => $p->no,
                    'nama' => $p->name,
                    'desc' => $p->description,
        ...
        if ($db->members->isNotEmpty()) {
            $dept['anggota'] = $db->members->map(function($m) {
                return [
                    ...
                    'foto_nobg' => $m->photo_nobg ? \Storage::url($m->photo_nobg) : ($m->photo ? \Storage::url($m->photo) : null),
                    'is_db' => true,
                ];
            })->toArray();
        } else {
