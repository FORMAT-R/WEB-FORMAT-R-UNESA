...
# ==============================================================
# Cara pakai:
#   1. Upload script ini ke /home/formatrunesa/formatr_core/web_format_r_unesa/
#   2. chmod +x deploy.sh
...
if [ -n "$(git status --porcelain)" ]; then
    ...
    echo "   Deploy dihentikan supaya tidak menimpa/merusak file seperti kejadian sebelumnya."
