...
<style>
  ...
  .bg-ornament svg, .bg-ornament i { width: 100%; height: 100%; display: block; }
    ...
    .ribbon {
      ...
      /* Disederhanakan menggunakan border-radius untuk performa render, menghindari ratusan titik polygon */
      border-radius: 4px;
    ...
    .ribbon.ribbon-blue::before { border-right-color: var(--blue-dark); }
    .ribbon.ribbon-blue::after { border-left-color: var(--blue-dark); }
