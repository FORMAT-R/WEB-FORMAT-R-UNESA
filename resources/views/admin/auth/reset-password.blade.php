...
<head>
    ...
    <title>Reset Kata Sandi - Admin FORMAT-R UNESA</title>
...
<body class="bg-gray-50 text-gray-900 dark:bg-gray-900 dark:text-gray-100 flex items-center justify-center min-h-screen p-4 selection:bg-primary-500 selection:text-white transition-colors duration-200"
    ...
    <div class="glass w-full max-w-md rounded-2xl p-8 relative z-10">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Buat Sandi Baru</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Buat kata sandi baru yang kuat untuk akun Anda</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.password.update') }}" class="space-y-5">
            ...
            <div class="space-y-1">
                ...
                <div class="relative">
                    ...
                    <input type="email" name="email" id="email" value="{{ $email ?? old('email') }}" required readonly
                        class="block w-full pl-10 pr-3 py-2.5 bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg text-gray-500 dark:text-gray-400 focus:outline-none cursor-not-allowed">
                </div>
            </div>
            ...
            <div class="space-y-1">
                <label for="password_confirmation" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Ulangi Kata Sandi Baru</label>
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            ...
            <button type="submit" class="btn-primary mt-6">
                Simpan Kata Sandi
                <i data-lucide="save" class="w-4 h-4 ml-1"></i>
            </button>
        </form>
    </div>
