...
<div class="space-y-6" x-data="newsForm()">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-gray-500 dark:text-gray-400 mt-1">Perbarui artikel berita dan pratinjau dalam layout koran.</p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div class="lg:col-span-5 space-y-6">
            <form action="{{ route('admin.berita.update', $berita->id) }}" method="POST" enctype="multipart/form-data" @submit="isSubmitting = true" class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
                @csrf
                @method('PUT')
                ...
                <div class="form-group mb-5">
                    ...
                    <input type="text" name="title" x-model="form.judul" required class="form-input" placeholder="Masukkan judul berita yang menarik">
                </div>
                ...
                <div class="form-group mb-6">
                    ...
                    <textarea name="content" x-model="form.konten" required class="form-textarea" rows="12" placeholder="Tuliskan isi berita di sini. Paragraf pertama akan otomatis mendapatkan efek Drop Cap khas koran..."></textarea>
...
function newsForm() {
    return {
        form: {
            ...
            tag: 'Kabar FORMAT',
            menit: 4,
            fotoPreview: '{!! $berita->image ? Storage::url($berita->image) : '' !!}',
            caption: '',
