...
<div class="max-w-4xl mx-auto">
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Pembina</h1>
            <p class="text-gray-500 dark:text-gray-400 text-sm mt-1">Tambahkan data riwayat pembina baru.</p>
        </div>
    </div>

    <form id="pembinaForm" action="{{ route('admin.pembinas.store') }}" method="POST" enctype="multipart/form-data" class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden shadow-sm">
        @csrf
        <div class="p-6 sm:p-8 space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="term_period" value="{{ old('term_period') }}" required placeholder="Misal: 2020 - Sekarang"
                        class="w-full rounded-xl border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-900 dark:text-white">
                </div>
            </div>
        ...
        <div class="bg-gray-50 dark:bg-gray-800/50 px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-3">
            ...
            <button type="submit" class="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-xl text-sm transition-colors shadow-sm shadow-blue-600/20">Simpan Pembina</button>
        </div>
    </form>
</div>
